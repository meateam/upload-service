...
func (*UploadMediaRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_upload_service_55ae58f2e409cd54, []int{0}
}
...
func (*UploadMediaResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_upload_service_55ae58f2e409cd54, []int{1}
}
...
func (*UploadMultipartRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_upload_service_55ae58f2e409cd54, []int{2}
}
...
func (*UploadMultipartResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_upload_service_55ae58f2e409cd54, []int{3}
}
...
func (*UploadInitRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_upload_service_55ae58f2e409cd54, []int{4}
}
...
func (*UploadInitResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_upload_service_55ae58f2e409cd54, []int{5}
}
...
func (*UploadPartRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_upload_service_55ae58f2e409cd54, []int{6}
}
...
func (*UploadPartResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_upload_service_55ae58f2e409cd54, []int{7}
}
...
func (*UploadCompleteRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_upload_service_55ae58f2e409cd54, []int{8}
}
...
func (*UploadCompleteResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_upload_service_55ae58f2e409cd54, []int{9}
}
...
func (*UploadAbortRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_upload_service_55ae58f2e409cd54, []int{10}
}
...
func (*UploadAbortResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_upload_service_55ae58f2e409cd54, []int{11}
}
...
func init() {
	proto.RegisterFile("upload_service.proto", fileDescriptor_upload_service_55ae58f2e409cd54)
}

var fileDescriptor_upload_service_55ae58f2e409cd54 = []byte{
	// 548 bytes of a gzipped FileDescriptorProto
	,
}
