...
type UploadCompleteResponse struct {
	...
	ContentLength int64 `protobuf:"varint,1,opt,name=ContentLength,json=contentLength,proto3" json:"ContentLength,omitempty"`
	// The type of the uploaded file
	ContentType string `protobuf:"bytes,2,opt,name=ContentType,json=contentType,proto3" json:"ContentType,omitempty"`
}
...
var file_upload_service_proto_rawDesc = []byte{
	...
	0x6d, 0x6f, 0x76, 0x65, 0x64, 0x32, 0xee, 0x04, 0x0a, 0x06, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64,
